...
//		String channel=RedisData.getConf(jedisClient,0,"channel");
//		String orderKey=RedisData.getConf(jedisClient,0,"orderKey");
//		String chargeExtract=RedisData.getConf(jedisClient,0,"chargeExtract");
...
//		TransExchange.tranGenOrderIn(now,uid,gameUser.getAgentId(),gameUser.getPresenterId(),mch_order_no,paramsMap.get(orderKey), "", "", cost, cost, "INR");	
//		return resData;
//	}
//	@Override
