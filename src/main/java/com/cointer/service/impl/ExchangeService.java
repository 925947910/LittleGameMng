...
//		sign= sign.replaceAll("/", "\\\\/");
		...
		try {
			if("1".equals(reqData.getString("tradeResult"))) {
				...
				int PresenterId=TransExchange.tranChargeSucc(reqData.getString("mchOrderNo"),custom.getIntValue("uid"),custom.getIntValue("coin"),Float.parseFloat(reqData.getString("amount")));
